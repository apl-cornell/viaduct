...
class BackendCodeGenerator(
    ...
    private val protocolAnalysis = ProtocolAnalysis(program, DefaultCombinedBackend.protocolComposer)
...
//                    throw CodeGenerationError("Code Generation: multiple code generators for protocol ${protocol.toDocument().print()}")
//                } else {
