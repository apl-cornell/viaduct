...
/**
 * A statement visitor that does not use context information and that automatically traverses
 * control structures (i.e. forces [SuspendedTraversal]s).
 *
...
interface StatementVisitor<ExpressionResult, StatementResult> :
    ...
    override fun getData(node: InputNode, data: Unit) {}

    override fun getData(node: ReceiveNode, data: Unit) {}
